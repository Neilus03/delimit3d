...
$PY scripts/evaluation/run_scannet40_joint.py \
  --config /cluster/work/igp_psr/nedela/delimit3d_scannet40_agile3d_joint_v1/freeze/resolved_config.yaml \
  --mode prepare
```
...
```bash
ROOT=/cluster/work/igp_psr/nedela/delimit3d_scannet40_agile3d_joint_v1
